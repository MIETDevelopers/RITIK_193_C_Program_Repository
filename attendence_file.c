// Purpose Of The Program:It reads file prepared in the previous program and then interacts with user asking any student's roll number and prints his/her attendance details.
